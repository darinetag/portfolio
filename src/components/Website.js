...
export default function ProjectExample({ title, subtitle, examples, subtitles, description, images, imagess }) {
  ...
  return (
    <Layout>
      <div className="lg:min-h-[100vh] min-h-[20vh] flex flex-col lg:px-6 relative overflow-visible" style={{ fontFamily: "Montreal" }}>
        {/* Page Title */}
        ...
        <div className="flex">
          {current.id === "blogs" ? (
            ...
            >
              <img
                src={current.images}
                alt="sticky note"
                className="lg:w-[340px] lg:h-[280px] w-[110px] h-[100px] lg:mr-2 cursor-pointer"
              />
            </a>
          ) : (
            <img
              src={current.images}
              alt="sticky note"
              className="lg:w-[340px] lg:h-[280px] w-[110px] h-[100px] lg:ml-2"
            />
          )}
          ...
          <img
            src={current.imagess}
            alt="sticky note"
            className="lg:w-[200px] lg:h-[180px] w-[80px] h-[70px] items-end lg:ml-200 ml-58 lg:mt-2 ml-0"
          />
        </div>

        <div className="relative w-full h-[1px] lg:mt-70 mt-54 ml-7 flex items-center justify-center flex-grow lg:pb-100 pb-70">
          {/* Left Arrow */}
          <button
            onClick={prev}
          ...
          <div className="lg:flex lg:items-center lg:justify-center ">
            <img
              ...
              className={`object-contain ${
                current.id === "about us"
                  ? "lg:w-[800px] w-[200px]  lg:h-[1600px] lg:mt-180 mt-20"
                  : "lg:w-[880px] w-[270px] lg:h-[800px] h-[400px]"
              }`}
            />
          </div>
          {/* Right Arrow */}
