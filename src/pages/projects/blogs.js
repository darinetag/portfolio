...
export default function BlogsProjectPage() {
  return (
    <Layout>
       <div className=" px-6 relative overflow-hidden" style={{ fontFamily: "Montreal" }}>
        {/* Page Title */}
        <h1 className="text-8xl text-[#0E2A8B] text-center my-8" style={{ fontFamily: "Science" }}>
          Blogs
        </h1>
  ...
  <a href="https://darinetag.hashnode.dev/designing-for-every-age-a-generational-ux-revolution" target="_blank" class="group cursor-pointer w-full max-w-5xl bg-[#B10000] text-white transition-all duration-500 overflow-hidden">
    <div class="relative w-full h-full p-10 min-h-[180px] flex items-center justify-center">
     
      <h2 class=" md:text-3xl font-light group-hover:opacity-0 transition-opacity duration-300 ease-in-out text-left">Designing for Every Age: A Generational UX Revolution</h2>
