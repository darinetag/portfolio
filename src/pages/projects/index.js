...
const projects = [
  ...
  { title: "Portfolios", href: "/projects/portfolios", color: "bg-[#0E2A8B]", style: "row-start-3 col-start-3 translate-y-[-160px]" },
  { title: "Challenges", href: "/projects/challenges", color: "bg-[#BC0700]", style: "row-start-4 col-start-2 translate-y-[-120px]" },
  { title: "Blogs", href: "/projects/blogs",  color: "bg-[#0E2A8B]", style: "row-start-4 col-start-4 translate-y-[-120px]" },
];
